...
protected:
    ...
    /* Adding this for temporary storage and writing to view actual values during output */
    /// Scalar average stress gradient 
    double StressGradient;
    
    /// Scalar average stress gradient 
    double tempStressGradient;
...
public:
    ...
    void setTempStressGradient (double value) {tempStressGradient = value;}
    
    double giveStressGradient() {return StressGradient;}
};
...
public:
    ...
    {
      ViscoPlastic :: computeXitaFromNodes(xita, gp, tstep);
    }
