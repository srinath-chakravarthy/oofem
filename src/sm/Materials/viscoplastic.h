 ...
 * It follows from Needelman Asaro Viscoplastic Model
 * associated with the corresponding non-local Stress gradient plasticity model
 * Currently valid only for small strain plasticity
 */
...
protected:
    ...
    /// Smoother to extract element nodal stress values
    NodalRecoveryModel *smoother;
    
    /// Element Set added to material
    /// Currently contains all elements
    Set elementSet;
...
public:
    ...
    */
    ...
    virtual void computeXitaFromNodes(double &xita, GaussPoint *gp, TimeStep *tStep);
